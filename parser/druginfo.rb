...
txt_file = File.new('%{medication}.txt' % {:medication => medication}, 'w+')
csv_file= CSV.open("%{medication}.csv" % {:medication => medication},'a')
